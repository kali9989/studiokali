...
export default function Footer() {
    return (
        <footer className="bg-noir rounded-t-[4rem] text-paper pt-32 pb-8 px-8 md:px-16 mt-[-4rem] relative z-30 border-t border-charcoal/50 shadow-[0_-20px_40px_rgba(0,0,0,0.5)]">

            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end border-b border-charcoal/30 pb-16 mb-8 gap-12">

                <div className="flex-1">
                    <div className="font-bebas text-6xl md:text-8xl lg:text-9xl uppercase leading-[0.8] mb-8">
                        STUDIO <br />
                    ...
                    <div className="flex items-center gap-3 text-sm font-jetbrains bg-[#141414] border border-charcoal rounded-full px-4 py-2 inline-flex">
                ...
                <div className="flex gap-12 md:gap-20">
                    <div className="flex flex-col gap-4 font-jakarta text-sm">
            ...
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-paper/40">
                <div className="font-cormorant italic text-lg text-paper/50">
